...
/**
 * \brief Setter method
 * \param uint16_t : The row dimension of the matrix.
 * \return None.
*/
	void setRow(uint16_t row);
/**
 * \brief Setter method
 * \param uint16_t : The column dimension of the matrix.
 * \return None.
*/
...
/**
 * \brief Method to print a matrix.
 * \return returns 'RC_SUCCESS'.
 */	
	RC_t printMatrix();
};

typedef CMatrix CMatrix_t;
